...
export async function proofGen(PK, signature, header, ph, messages,
  ...
  console.log(`r1 = ${r1} or ${r1.toString(16)}`);
  // Bbar = B * r1 - Abar * e
...
export function octets_to_proof(octets) { // TEMPORARILY EXPORT FOR DEBUGGING
...
export function octets_to_sig(sig_octets) { // TEMPORARILY EXPORT THIS FOR DEBUG
