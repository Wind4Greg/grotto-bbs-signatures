...
export async function proofGen(PK, signature, header, ph, messages,
  ...
  console.log(`Sig: ${bytesToHex(signature)}`);
  console.log(`Abar: ${bytesToHex(Abar.toRawBytes(true))}`);
  console.log(`Bbar: ${bytesToHex(Bbar.toRawBytes(true))}`);
  console.log(`D: ${bytesToHex(D.toRawBytes(true))}`);
  console.log(`T1: ${bytesToHex(T1.toRawBytes(true))}`);
  console.log(`T2: ${bytesToHex(T2.toRawBytes(true))}`);
  console.log(`Domain: ${domain.toString(16)}`);
  console.log(`Challenge: ${c.toString(16)}`);
  randScalars.forEach((rs, i) =>
    console.log(`randScalar[${i}] = ${rs.toString(16)}`));
