...
import {BlindSign, BlindVerify, calcM, deserialize_and_validate_commit, FinalizeBlindSign} from './BlindBBS.js';
import {
...
export async function Finalize(PK, signature, header, messages, committed_messages,
  prover_nym, signer_nym_entropy, secret_prover_blind) {
...
async function CoreProofGenWithPseudonym(PK, signature, Pseudonym, verifier_id, generators,
