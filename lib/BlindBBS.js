...
import {bytesToHex, calculate_domain, calculate_random_scalars, concat,
  hash_to_scalar, i2osp, numberToHex, octets_to_sig, os2ip, prepareGenerators, ProofFinalize,
  ProofInit, proofVerify, serialize, signature_to_octets, verify}
  from './BBS.js';
...
/*
Proposed:
BlindProofVerify(PK,proof, header, ph, issuer_known_messages_no, disclosed_messages, message_disclosures)
*/
/**
 *
 * @param {Uint8Array} PK - Public key as a compressed G2 point raw bytes.
